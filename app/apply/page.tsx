      ...
      <div className="pt-24 pb-16 min-h-screen relative">
        ...
        <div className="max-w-3xl mx-auto px-6">
                      ...
                      <div className="flex gap-4 mt-2">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 text-[#0f79be] focus:ring-[#0f79be]"
                          />
                      ...
                      <div className="flex gap-4 mt-2">
                        <label className="flex items-center gap-2 cursor-pointer">
                          <input
                            ...
                            className="w-4 h-4 text-[#0f79be] border-gray-300 focus:ring-[#0f79be]"
                          />
                          <span className="text-gray-700">Yes</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    {formData.properties.length === 0 ? (
                      <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-lg">
                        ...
                        <button
                          type="button"
                          onClick={addProperty}
                          className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-[#0f79be] border border-[#0f79be] rounded-lg hover:bg-[#0f79be]/5 transition-colors"
                        >
                      ...
                      <>
                        ...
                        {formData.properties.length < 4 && (
                          <button
                            type="button"
                            onClick={addProperty}
                            className="w-full py-3 border-2 border-dashed border-gray-200 rounded-lg text-gray-500 hover:border-[#0f79be] hover:text-[#0f79be] transition-colors flex items-center justify-center gap-2"
                          >
                            <PlusIcon className="w-4 h-4" />
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div
                      ...
                      className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-[#0f79be] transition-colors"
                    >
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <button
                        ...
                        className="text-sm text-[#0f79be] hover:text-[#0b5e96] transition-colors"
                      >
                        Clear Signature
                      </button>
                    </div>
          ...
          <p className="text-xs text-gray-500 text-center mt-6">
            ...
            <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#0f79be]">
              Privacy Policy
            </a>{' '}
            and{' '}
            <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#0f79be]">
              Terms of Service
            </a>{' '}
            apply.
          </p>
