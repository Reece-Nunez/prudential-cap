...
function drawSectionHeader(
  ...
  // Blue accent line instead of gold
  page.drawLine({
    start: { x: margin, y: y + 5 },
    end: { x: pageWidth - margin, y: y + 5 },
    thickness: 1,
    color: rgb(0.06, 0.47, 0.75), // #0f79be
  });
...
export async function generateApplicationPDF(
  ...
  try {
    const logoPath = path.join(process.cwd(), 'public', 'prud-cap-logo.png');
  ...
  const authorizationText = [
    'By signing below, each of the businesses and business owners/officers listed above (individually and collectively, "You") authorize Prudential',
    'Capital, and its representatives, successors, assigns, and designees (collectively, "Recipients"), who may be involved in or acquire',
    ...
    'to access and review financial records, including but not limited to bank statements and credit card processor statements. Prudential Capital',
    'is further authorized to transmit this application, together with any information obtained in connection with it, to any or all Recipients for the',
    'purposes described above.',
    '',
    'You further authorize any creditor or financial institution to release information relating to You directly to Prudential Capital and its Principals.',
    'You also consent to receive any legally required notices by electronic mail at the email address provided in this application. In addition, You',
    'authorize any lender or Recipient to contact You by telephone call or text message for marketing purposes at the phone number(s) provided',
    'in this application, even if such number(s) appear on a state, federal, or corporate "Do Not Call" registry.',
    '',
  ...
  const footerText1 = 'Prudential Capital | Business Funding Solutions';
